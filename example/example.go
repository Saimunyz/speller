...
func main() {
	...
	correct = speller.SpellCorrect2("фотощтора короткин занавескм крамивые шторф коассические шторв шторф на два окнв размеп х см")
	fmt.Println("фотощтора короткин занавескм крамивые шторф коассические шторв шторф на два окнв размеп х см ->", correct)
